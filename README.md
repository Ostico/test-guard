...
|:---------|:--------------|:-----------|:-----------------|
| Google Gemini | `https://generativelanguage.googleapis.com/v1beta/openai/` | `gemini-2.5-flash` | Per-model quotas are shown in [AI Studio](https://aistudio.google.com/rate-limit); token/min is roomy |
